...
public class LineSegment
    ...
    /*     	      AC dot AB
        ...
        */
        ...
        double r = ((p.x - this.p0.x) * dx + (p.y - this.p0.y) * dy)
                / len;
        return r;
    }
    ...
    public Coordinate closestPoint(Coordinate p) {
        ...
        double dist1 = this.p1.distance(p);
        if (dist0 < dist1) {
            return this.p0;
        }
        return this.p1;
    ...
    public Coordinate[] closestPoints(LineSegment line) {
        ...
        Coordinate close10 = line.closestPoint(this.p0);
        ...
        Coordinate close11 = line.closestPoint(this.p1);
     ...
     */
    public int hashCode() {
        long bits0 = java.lang.Double.doubleToLongBits(this.p0.x);
        bits0 ^= java.lang.Double.doubleToLongBits(this.p0.y) * 31;
        int hash0 = (((int) bits0) ^ ((int) (bits0 >> 32)));

        long bits1 = java.lang.Double.doubleToLongBits(this.p1.x);
