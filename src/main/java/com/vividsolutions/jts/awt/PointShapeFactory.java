...
public interface PointShapeFactory {
    ...
    class Star extends BasePointShapeFactory {
        ...
        public Shape createPoint(Point2D point) {
            ...
            path.moveTo((float) point.getX(), (float) (point.getY() - this.size / 2));
            path.lineTo((float) (point.getX() + this.size * 1 / 8), (float) (point.getY() - this.size * 1 / 8));
            path.lineTo((float) (point.getX() + this.size / 2), (float) (point.getY() - this.size * 1 / 8));
            path.lineTo((float) (point.getX() + this.size * 2 / 8), (float) (point.getY() + this.size * 1 / 8));
            path.lineTo((float) (point.getX() + this.size * 3 / 8), (float) (point.getY() + this.size / 2));
            path.lineTo((float) (point.getX()), (float) (point.getY() + this.size * 2 / 8));
            path.lineTo((float) (point.getX() - this.size * 3 / 8), (float) (point.getY() + this.size / 2));
            path.lineTo((float) (point.getX() - this.size * 2 / 8), (float) (point.getY() + this.size * 1 / 8));
            path.lineTo((float) (point.getX() - this.size / 2), (float) (point.getY() - this.size * 1 / 8));
            path.lineTo((float) (point.getX() - this.size * 1 / 8), (float) (point.getY() - this.size * 1 / 8));
    ...
    class Triangle extends BasePointShapeFactory {
        ...
        public Shape createPoint(Point2D point) {
            ...
            GeneralPath path = new GeneralPath();
            path.moveTo((float) (point.getX()), (float) (point.getY() - this.size / 2));
            path.lineTo((float) (point.getX() + this.size / 2), (float) (point.getY() + this.size / 2));
            path.lineTo((float) (point.getX() - this.size / 2), (float) (point.getY() + this.size / 2));
            path.lineTo((float) (point.getX()), (float) (point.getY() - this.size / 2));
    ...
    class Cross extends BasePointShapeFactory {
        ...
        public Shape createPoint(Point2D point) {
            ...
            float x1 = (float) (point.getX() - this.size / 2f);
            float x2 = (float) (point.getX() - this.size / 4f);
            float x3 = (float) (point.getX() + this.size / 4f);
            float x4 = (float) (point.getX() + this.size / 2f);

            float y1 = (float) (point.getY() - this.size / 2f);
            float y2 = (float) (point.getY() - this.size / 4f);
            float y3 = (float) (point.getY() + this.size / 4f);
            float y4 = (float) (point.getY() + this.size / 2f);
    ...
    class X extends BasePointShapeFactory {
        ...
        public Shape createPoint(Point2D point) {
            GeneralPath path = new GeneralPath();
            path.moveTo((float) (point.getX()), (float) (point.getY() - this.size * 1 / 8));
            path.lineTo((float) (point.getX() + this.size * 2 / 8), (float) (point.getY() - this.size / 2));
            path.lineTo((float) (point.getX() + this.size / 2), (float) (point.getY() - this.size / 2));
            path.lineTo((float) (point.getX() + this.size * 1 / 8), (float) (point.getY()));
            path.lineTo((float) (point.getX() + this.size / 2), (float) (point.getY() + this.size / 2));
            path.lineTo((float) (point.getX() + this.size * 2 / 8), (float) (point.getY() + this.size / 2));
            path.lineTo((float) (point.getX()), (float) (point.getY() + this.size * 1 / 8));
            path.lineTo((float) (point.getX() - this.size * 2 / 8), (float) (point.getY() + this.size / 2));
            path.lineTo((float) (point.getX() - this.size / 2), (float) (point.getY() + this.size / 2));
            path.lineTo((float) (point.getX() - this.size * 1 / 8), (float) (point.getY()));
            path.lineTo((float) (point.getX() - this.size / 2), (float) (point.getY() - this.size / 2));
