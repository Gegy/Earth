...
public class GeometryEditor {
    ...
    private GeometryCollection editGeometryCollection(
        ...
        if (collectionForType.getClass() == MultiPoint.class) {
            return this.factory.createMultiPoint((Point[]) geometries.toArray(
                    new Point[] {}));
        }
        if (collectionForType.getClass() == MultiLineString.class) {
            return this.factory.createMultiLineString((LineString[]) geometries.toArray(
                    new LineString[] {}));
        }
        if (collectionForType.getClass() == MultiPolygon.class) {
            return this.factory.createMultiPolygon((Polygon[]) geometries.toArray(
                    new Polygon[] {}));
        }
        return this.factory.createGeometryCollection((Geometry[]) geometries.toArray(
                new Geometry[] {}));
    }
