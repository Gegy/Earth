...
public class GeometryTransformer {
    ...
    protected Geometry transformPoint(Point geom, Geometry parent) {
        return this.factory.createPoint(
                this.transformCoordinates(geom.getCoordinateSequence(), geom));
    }
    ...
    protected Geometry transformPolygon(Polygon geom, Geometry parent) {
        ...
        Geometry shell = this.transformLinearRing((LinearRing) geom.getExteriorRing(), geom);
...
//return factory.createPolygon(null, null);
        ...
        for (int i = 0; i < geom.getNumInteriorRing(); i++) {
            Geometry hole = this.transformLinearRing((LinearRing) geom.getInteriorRingN(i), geom);
        ...
        if (isAllValidLinearRings) {
            return this.factory.createPolygon((LinearRing) shell,
