...
public class IntersectionMatrix implements Cloneable {
    ...
    public boolean isDisjoint() {
        return
                this.matrix[Location.INTERIOR][Location.INTERIOR] == Dimension.FALSE &&
    ...
    public boolean isTouches(int dimensionOfGeometryA, int dimensionOfGeometryB) {
        ...
        if ((dimensionOfGeometryA == Dimension.A && dimensionOfGeometryB == Dimension.A) ||
            ...
            return this.matrix[Location.INTERIOR][Location.INTERIOR] == Dimension.FALSE &&
                    (isTrue(this.matrix[Location.INTERIOR][Location.BOUNDARY])
                            || isTrue(this.matrix[Location.BOUNDARY][Location.INTERIOR])
                            || isTrue(this.matrix[Location.BOUNDARY][Location.BOUNDARY]));
        }
        return false;
    }
    ...
    public boolean isCrosses(int dimensionOfGeometryA, int dimensionOfGeometryB) {
        if ((dimensionOfGeometryA == Dimension.P && dimensionOfGeometryB == Dimension.L) ||
                (dimensionOfGeometryA == Dimension.P && dimensionOfGeometryB == Dimension.A) ||
                (dimensionOfGeometryA == Dimension.L && dimensionOfGeometryB == Dimension.A)) {
            return isTrue(this.matrix[Location.INTERIOR][Location.INTERIOR]) &&
                    isTrue(this.matrix[Location.INTERIOR][Location.EXTERIOR]);
        }
        if ((dimensionOfGeometryA == Dimension.L && dimensionOfGeometryB == Dimension.P) ||
            ...
            return isTrue(this.matrix[Location.INTERIOR][Location.INTERIOR]) &&
                    isTrue(this.matrix[Location.EXTERIOR][Location.INTERIOR]);
        }
    ...
    public boolean isCovers() {
        boolean hasPointInCommon =
                isTrue(this.matrix[Location.INTERIOR][Location.INTERIOR])
                        || isTrue(this.matrix[Location.INTERIOR][Location.BOUNDARY])
                        || isTrue(this.matrix[Location.BOUNDARY][Location.INTERIOR])
                        || isTrue(this.matrix[Location.BOUNDARY][Location.BOUNDARY]);
    ...
    public boolean matches(String requiredDimensionSymbols) {
        ...
        for (int ai = 0; ai < 3; ai++) {
            for (int bi = 0; bi < 3; bi++) {
                if (!matches(this.matrix[ai][bi], requiredDimensionSymbols.charAt(3 * ai +
                        bi))) {
                    return false;
                }
            }
