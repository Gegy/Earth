...
public class GeometricShapeFactory {
    ...
    public Polygon createRectangle() {
        ...
        double XsegLen = this.dim.getEnvelope().getWidth() / nSide;
        double YsegLen = this.dim.getEnvelope().getHeight() / nSide;
...
//* @deprecated use {@link createEllipse} instead
    ...
    public Polygon createSupercircle(double power) {
        ...
        double radius = this.dim.getMinSize() / 2;
    ...
    protected class Dimensions {
        ...
        public Envelope getEnvelope() {
            ...
            if (this.centre != null) {
                return new Envelope(this.centre.x - this.width / 2, this.centre.x + this.width / 2,
                        this.centre.y - this.height / 2, this.centre.y + this.height / 2);
            }
