...
public class CommonBitsOp {
    ...
    private Geometry removeCommonBits(Geometry geom0) {
        ...
        this.cbr.add(geom0);
        Geometry geom = this.cbr.removeCommonBits((Geometry) geom0.clone());
        return geom;
    }
    ...
    private Geometry[] removeCommonBits(Geometry geom0, Geometry geom1) {
        ...
        geom[0] = this.cbr.removeCommonBits((Geometry) geom0.clone());
        geom[1] = this.cbr.removeCommonBits((Geometry) geom1.clone());
        return geom;
    }
}
