...
public class GeometryFactory
    ...
    public Geometry toGeometry(Envelope envelope) {
        ...
        return this.createPolygon(this.createLinearRing(new Coordinate[] {
                new Coordinate(envelope.getMinX(), envelope.getMinY()),
    ...
    public MultiPoint createMultiPoint(Coordinate[] coordinates) {
        return this.createMultiPoint(coordinates != null
                ? this.getCoordinateSequenceFactory().create(coordinates)
                : null);
    }
    ...
    public MultiPoint createMultiPoint(CoordinateSequence coordinates) {
        ...
        for (int i = 0; i < coordinates.size(); i++) {
            CoordinateSequence ptSeq = this.getCoordinateSequenceFactory()
    ...
    public Geometry buildGeometry(Collection geomList) {
        ...
        if (isHeterogeneous || hasGeometryCollection) {
            return this.createGeometryCollection(toGeometryArray(geomList));
        }
        ...
        if (isCollection) {
            if (geom0 instanceof Polygon) {
                return this.createMultiPolygon(toPolygonArray(geomList));
